		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-6 order-lg-2">
					<div class="p-5">
						<a href="/getChart1"><img class="img-fluid rounded-circle"
							src="${pageContext.request.contextPath}/resources/img/01.jpg"
							alt=""></a>
					</div>
				</div>
				...
				<div class="col-lg-6">
					<div class="p-5">
						<img class="img-fluid rounded-circle"
							src="${pageContext.request.contextPath}/resources/img/02.jpg"
							alt="">
					</div>
				</div>
				<div class="col-lg-6">
		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-6 order-lg-2">
					<div class="p-5">
						<img class="img-fluid rounded-circle"
							src="${pageContext.request.contextPath}/resources/img/03.jpg"
							alt="">
					</div>
				</div>
				<div class="col-lg-6 order-lg-1">
